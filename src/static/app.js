document.addEventListener("DOMContentLoaded", () => {
  ...
  activitiesList.addEventListener("click", async (event) => {
    ...
    const encodedActivityName = deleteButton.dataset.activityName;
    const encodedParticipantEmail = deleteButton.dataset.participantEmail;

    if (!encodedActivityName || !encodedParticipantEmail) {
      return;
    }

    const activityName = decodeURIComponent(encodedActivityName);
    const participantEmail = decodeURIComponent(encodedParticipantEmail);
